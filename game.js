...
function handleZAction() {
  customerList.forEach(c => {
    ...
    if (dx + dy <= tileSize + 10) {
      if (c.state === "ordered") {
        clearTimeout(c.angerTimer); // ← 60秒タイマー解除
        c.state = "waiting";
...
function getDynamicSpawnTime() {
  const levels = [
    ...
    { score: 500, interval: 25000 },
    { score: 1000, interval: 20000 },
    { score: 1500, interval: 15000 },
    { score: 2000, interval: 12000 },
    { score: 2500, interval: 10000 },
    { score: 3000, interval: 5000 } // 最速レベル
  ];
